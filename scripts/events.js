(function () {
    ...
    function attachRowActions(row, detailsRow, eventId, store) {
    ...
    function renderEvents() {
        ...
        events.forEach((event) => {
            ...
            attachRowActions(row, detailsRow, event.id, store);
        });
    }
    ...
    function handleFormSubmission() {
        ...
        form.addEventListener('submit', (event) => {
            ...
            if (!store) {
                console.warn('B2UStore is not available. Unable to add events.');
                return;
            }
